...
[![Actions Status](https://github.com/3ldar/go-signalr/workflows/Build%20and%20Test/badge.svg)](https://github.com/3ldar/go-signalr/actions)
[![codecov](https://codecov.io/gh/philippseith/signalr/branch/master/graph/badge.svg)](https://codecov.io/gh/philippseith/signalr)
[![PkgGoDev](https://pkg.go.dev/badge/github.com/3ldar/go-signalr)](https://pkg.go.dev/github.com/3ldar/go-signalr)
...
```sh
go get -u github.com/3ldar/go-signalr
```
...
import "github.com/3ldar/go-signalr"
